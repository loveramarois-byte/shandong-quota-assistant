...
2. 只下载 `ShandongQuotaAssistant-Setup-0.8.2.exe`。
...
需要批量部署时，可使用静默参数：`ShandongQuotaAssistant-Setup-0.8.2.exe /VERYSILENT /SUPPRESSMSGBOXES /NORESTART`。

完整版包含山东 2016/2025 定额、2013/2024 清单、清单定额关联、人材机消耗和已登记原书页信息。结构化资料是普通套项的主要依据，PDF 页不是确认和导出的强制门禁。资料权利说明与适用边界见 [DATA_NOTICE.md](legal/DATA_NOTICE.md)。
