...
需要批量部署时，可使用静默参数：`山东定额助手-Setup-0.9.3.exe /VERYSILENT /SUPPRESSMSGBOXES /NORESTART`。

完整版包含山东 2016/2025 定额、2013/2024 清单、清单定额关联和人材机消耗。0.9.3 的结构化运行库约 218 MB，不携带 PDF、OCR 页或原书路径；PDF 页不是确认和导出的强制门禁。资料权利说明与适用边界见 [DATA_NOTICE.md](legal/DATA_NOTICE.md)。
