...
2. 只下载 `ShandongQuotaAssistant-Setup-0.8.7.exe`。
...
需要批量部署时，可使用静默参数：`ShandongQuotaAssistant-Setup-0.8.7.exe /VERYSILENT /SUPPRESSMSGBOXES /NORESTART`。
...
- **现代桌面交互**：PyQt6 原生桌面界面、自定义暖灰设计系统、Inter 字体、SVG 图标、浅色/深色主题与信号驱动的非阻塞分析流程。
